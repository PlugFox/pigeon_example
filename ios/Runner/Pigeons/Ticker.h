...
@interface TickerDelay : NSObject
@property(nonatomic, strong, nullable) NSNumber * delay;
@end

@interface TickerResult : NSObject
@property(nonatomic, strong, nullable) NSNumber * successful;
...
NSObject<FlutterMessageCodec> *TickerSenderGetCodec(void);

@protocol TickerSender
- (nullable TickerResult *)startTickerDelay:(TickerDelay *)tickerDelay error:(FlutterError *_Nullable *_Nonnull)error;
- (nullable TickerResult *)stopWithError:(FlutterError *_Nullable *_Nonnull)error;
@end

extern void TickerSenderSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<TickerSender> *_Nullable api);

/// The codec used by TickerReceiver.
NSObject<FlutterMessageCodec> *TickerReceiverGetCodec(void);

@interface TickerReceiver : NSObject
- (instancetype)initWithBinaryMessenger:(id<FlutterBinaryMessenger>)binaryMessenger;
- (void)onTickTickerMessage:(TickerMessage *)tickerMessage completion:(void(^)(NSError *_Nullable))completion;
@end
